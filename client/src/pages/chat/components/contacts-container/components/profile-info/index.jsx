        ...
        <div className="flex gap-5">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="bg-[#1c1b1e] border-none text-green-600">Edit Profile</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="bg-[#1c1b1e] border-none text-green-600">LogOut</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
    </div>
