    ...
    <>
      <TooltipProvider>
        <Tooltip>
            ...
            <TooltipContent className="bg-[#1c1b1e] border-none mb-2 p-3 text-green-500">Select New Contact</TooltipContent>
        </Tooltip>
      </TooltipProvider>
      <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
        <DialogContent className="bg-[#181920] border-none text-green-500 w-[400px] h-[400px] flex flex-col">
          <DialogHeader>
